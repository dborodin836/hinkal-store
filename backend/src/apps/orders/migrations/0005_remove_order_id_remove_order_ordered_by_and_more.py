...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('new', 'new order'), ('pending', 'pending order'),
                                            ('finished', 'finished order'),
                                            ('canceled', 'canceled order')], default='new',
                                   max_length=200),
        ),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(auto_created=True, default=None,
